/**
 * @mainpage Sensor Interface
 * @section Introduction
 * Ce firmware est destiné à la carte Sensor Interface, équipée d'un PIC18F4550.
 *
                ...
                if (!HIDTxHandleBusy(USBInHandle)) {
                    ...
                    switch (ReceivedDataBuffer.DATA[0]) {
                        ...
                        case GET_BOARD_INFO:
                            ...
                            strcatpgm2ram((char *) &ToSendDataBuffer.DATA[0], (const rom far char *) "Sensor Interface 1.0\nNicolas DANDRIMONT");
                        break;
