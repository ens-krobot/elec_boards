...
export LoadConfig_teleuscms
export _LoadConfig_teleuscms
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_teleuscms
	lcall	LoadConfigTBL_teleuscms_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration teleuscms
;
;    Load configuration registers for teleuscms.
...
;               CUR_PP
;
_LoadConfig_teleuscms:
 LoadConfig_teleuscms:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_teleuscms_Bank0
    mov     X, <LoadConfigTBL_teleuscms_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_teleuscms_Bank1
    mov     X, <LoadConfigTBL_teleuscms_Bank1
